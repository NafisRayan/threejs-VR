...
const _template = () => {
    const { _create, initScene, initRenderer, initCamera, initControls, initRoom, initRaycaster, initController1, initController2 } = useTemplate();
...
const createHand = () => {
    ...
    const options = {
        requiredFeatures: ['instruction', 'handRay', 'panel'], // button, draggable, handRay, instruction
